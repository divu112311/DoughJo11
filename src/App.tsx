      ...
      <>
        ...
        <div className="min-h-screen bg-cream-50 flex items-center justify-center">
          <motion.div
            ...
            className="w-8 h-8 border-2 border-sage-600 border-t-transparent rounded-full"
          />
        </div>
      </>
    );
      ...
      <>
        ...
        <div className="min-h-screen bg-cream-50 flex items-center justify-center p-4">
          <motion.div
            ...
            className="bg-cream-100/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-cream-200 text-center max-w-md w-full"
          >
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      ...
      <motion.header 
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="bg-cream-100/80 backdrop-blur-md border-b border-cream-200 sticky top-0 z-40"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              >
                <div className="w-10 h-10 bg-gradient-to-br from-sage-600 to-bronze-500 rounded-full flex items-center justify-center p-1">
                  <img 
                    src="/finapp.png" 
                    alt="DoughJo Mascot" 
              ...
              <div className="flex items-center space-x-2 bg-sage-600 text-white px-3 py-1 rounded-full text-sm">
